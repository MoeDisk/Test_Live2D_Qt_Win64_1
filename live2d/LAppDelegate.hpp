...
public:
    ...
    */
//    bool Initialize();
    bool Initialize(openglive2d*window);
...
//    void OnMouseCallBack(openglive2d* window, int button, int action, int modify);
...
//    void OnMouseCallBack(openglive2d* window, double x, double y);
...
//    GLFWwindow* GetWindow() { return _window; }
    openglive2d*GetWindow(){return _window;}
...
//    static void OnMouseCallBack(openglive2d* window, int button, int action, int modify)
    {
...
//    static void OnMouseCallBack(openglive2d* window, double x, double y)
    {
